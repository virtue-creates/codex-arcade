# Codex Arcade v0.1 Announcement Kit

Codex Arcade v0.1公開時に使う告知文とUTMリンク。
...
```txt
Codex Arcade is a small online arcade built with a human director and Codex agents.

v0.1 features Cabinet 01: Neon Core Survivor.
Players can leave a "Manager Memo" after playing, and the project will use those notes for the next improvement cycle.
