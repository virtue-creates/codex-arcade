...
- GA4 Measurement IDとFormspree endpointは未接続のため、外部送信確認は対象外。
...
- GA4 Realtime confirmation is blocked until a real `GA_MEASUREMENT_ID` is provided.
...
- Human DirectorによるGA4 Measurement ID提供。
