...
- `docs/cabinet-intake.md`
- `docs/game-design-intent-report.md`
...
| 重要な方針変更の履歴 | `docs/roadmap-history.md` |
| v0.1公開ロードマップ | `docs/release-v0.1-roadmap.md` |
| v0.1同時並行運用 | `docs/v0.1-parallel-operations-plan.md` |
| 公開チェック | `docs/release-v0.1-checklist.md` |

## Key Operating Docs

| Area | File |
|---|---|
| 会社モデル | `docs/company-model.md` |
| 組織図 | `docs/organization-map.md` |
| 部署運用 | `docs/department-operating-model.md` |
| 人間とAIの共創 | `docs/human-agent-collaboration.md` |
| PR/運営トーン | `docs/pr-tone-policy.md` |
| BACKYARD方針 | `docs/backyard-policy.md` |
| BACKYARDの見せ方 | `docs/backyard-showcase-plan.md` |
